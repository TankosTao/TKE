...
def setup_logger(log_file_path: str = None):
    ...
    logger = logging.getLogger('DKE.pytorch')
...
def draw_bbox(img_path, result, color=(255, 0, 0),color_point= (0, 0, 255),circle_size=2, thickness=1):
    ...
    for point in result:
        ...
        for po in point:
            ...
            img_path = cv2.circle(img_path, (int(po[0]), int(po[1])), circle_size,color_point,2)
